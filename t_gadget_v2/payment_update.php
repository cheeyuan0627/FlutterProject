...
if ($paidstatus=="true"){
  $receiptid = $_GET['billplz']['id'];
        ...
        $sqlinsertintopaid = "INSERT INTO PAID(EMAIL,AMOUNT,RECEIPTID) VALUES ('$userid','$amount','$receiptid')";
     ...
     <p><center>Press back button to return to T Gadget</center></p></div></body>';
}
else{
